...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        app_state.model1 = OpenAIChatCompletionsModel(model="gemini-3-flash-preview", openai_client=app_state.gemini_client1)
        app_state.model2 = OpenAIChatCompletionsModel(model="gemini-3-flash-preview", openai_client=app_state.gemini_client2)
